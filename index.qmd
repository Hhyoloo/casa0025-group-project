...
| **Population density** | Population density layer | Input variable used to derive exposure context | LSOA / raster | [ONS](https://geoportal.statistics.gov.uk/) / [WorldPop](https://hub.worldpop.org/) |
| **Heat exposure** | Derived layer | Combined 2021 LST and population density used in Module 3 | LSOA | Derived layer |
...
Population density and cool-space accessibility are not included directly in the score itself. They are introduced afterwards as interpretation layers: population density contributes to a separate heat exposure layer derived together with 2021 LST, while cool-space locations are used to assess local accessibility through 500 m catchment buffers. Higher CCS values therefore indicate relatively poorer local cooling conditions, while lower values indicate relatively more favourable environmental cooling conditions.
...
<svg viewBox="0 0 860 430" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="563" y="343" text-anchor="middle" class="node-sub small">LST + population</text>
