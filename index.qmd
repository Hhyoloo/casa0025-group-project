...
London faces rising heat risks due to the Urban Heat Island effect, creating an urgent need for neighborhood-level cooling research. While London Policy G5 (2021) set ambitious greening targets, evaluating their real-world impact at the LSOA scale remains difficult. Our application addresses this gap by offering a platform for planners to visualize Cooling Condition Scores (CCS) alongside official 2025 Cool Spaces. By bridging the methodology of (Turner et al., 2025) with local governance, it supports evidence-based planning and ensures cooling resources reach the neighborhoods that need them most.
...
| :--- | :--- | :--- |
| [cite_start]**Static Models** [cite: 27] | [cite_start]Current analysis is based on precomputed CCS trends (2022–2025), which limits adaptability to sudden environmental shifts or new urban developments[cite: 27]. | [cite_start]Integrate real-time satellite feeds or live sensor data to enhance responsiveness to active heatwave events[cite: 28]. |
| [cite_start]**Granularity of Analysis** [cite: 29] | [cite_start]Analysis at the LSOA level makes it difficult for users to decide the exact locations for new trees or cooling infrastructure[cite: 30]. | [cite_start]Provide more detailed data at the street or block level to allow for more precise planning[cite: 30]. |
| [cite_start]**Report Export** [cite: 31] | [cite_start]Lack of export features makes it difficult for stakeholders to document findings or share evidence-based insights during planning consultations and meetings[cite: 32]. | [cite_start]Add functionality to export analysis reports or map snapshots to support documentation and cross-departmental sharing[cite: 32]. |
