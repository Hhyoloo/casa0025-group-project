...
This design separates environmental cooling condition from social exposure and service accessibility. CCS measures the physical cooling environment, while heat exposure and cool-space access help interpret who may be affected and whether formal cooling resources are spatially aligned with need. Keeping these components separate avoids presenting the score as a complete heat-risk index and makes the analytical logic easier to audit.

Heat exposure and cool-space accessibility are introduced afterwards as interpretation layers. Heat exposure combines surface heat conditions with census population count at LSOA level, while cool-space locations are assessed using a 500 m walking-distance buffer to compare relative local accessibility. Higher CCS values therefore indicate relatively poorer local cooling conditions, while lower values indicate more favourable environmental cooling conditions.
...
The interface is organised as a three-module workflow that moves from environmental conditions to planning interpretation.

Users move between three linked modules: urban heat environment, cooling condition assessment, and heat exposure with cool-space accessibility. Together, the modules create a progressive analytical sequence, moving from environmental heat conditions to changing cooling capacity and finally to the spatial relationship between exposure and cooling provision.

Module 1 presents LST, NDVI and NDBI derived from Landsat 8/9 and Sentinel-2 imagery for 2022, 2024 and 2025. Users can select indicators and years, adjust layer opacity, and click any LSOA to retrieve zonal statistics.

Module 2 visualises annual Cooling Condition Score layers together with the 2022–2025 change layer. A filter control allows users to isolate areas of improvement or decline, while official indoor Cool Space locations are displayed for comparison.

Module 3 combines LSOA-level heat exposure with 500 m walking-distance catchments around indoor Cool Spaces, helping users identify where higher exposure may coincide with weaker access to formal cooling provision.

This structure keeps the platform accessible for non-technical users while preserving the analytical logic behind the interpretation layers.

::: {#fig-interface layout-ncol=3}
![Cooling Condition Score](images/interface1.png)

![Areas of Cooling Decline](images/interface2.png)

![High Heat Exposure Areas](images/interface3.png)

By filtering indicators and overlaying layers, the interface highlights that many formal Cool Spaces remain concentrated in environmentally warmer areas. The change layer further suggests that cooling conditions have deteriorated across many parts of London, while high-exposure neighbourhoods remain unevenly covered by formal cool-space provision.
:::
