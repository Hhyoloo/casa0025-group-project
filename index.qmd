...
The method is designed as a transparent environmental screening framework rather than a predictive heat-risk model. LST, NDVI and NDBI are first normalised to a common 0–1 scale. LST and NDBI are treated as pressure indicators, because higher values suggest stronger surface heat burden and built-surface intensity. NDVI is treated in the opposite direction: higher NDVI indicates stronger vegetation-related cooling potential, so it is reversed before being added to the score.
...
In this score, higher values indicate relatively poorer cooling conditions, while lower values indicate relatively more favourable cooling conditions. Population density and cool-space accessibility are not included in the score itself. They are used afterwards as interpretation layers to identify where poor environmental cooling conditions may affect more residents or coincide with weaker access to cooling resources.
